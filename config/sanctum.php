...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Guard Map For path-based Guard Resolution Strategy
    |--------------------------------------------------------------------------
    |
    | Specify the guards sanctum should use in authenticating users for SPA Implementation
    | Use path pattern as key
    | Supported guards must use the session driver
    |
    | Format: 'path' => 'guard'
    | Eg: 'customer/*' => 'customers-spa'
    |
    */
